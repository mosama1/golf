    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse col-md-7">
      <ul class="nav navbar-nav navbar-right" id="items">
        <li><a href="inicio.php" id="ir-index">Inicio</a></li>
				<li><a href="#" onclick="contenido('reservasAdmin.php', <?php echo $userRow->id ?>)">Reservas</a></li>
				<li><a href="#" onclick="contenido('departamento.php', <?php echo $userRow->id ?>)">Departamento</a></li>
